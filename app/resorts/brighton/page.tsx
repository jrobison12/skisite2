  ...
  return (
    <main className="min-h-screen bg-white relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 flex items-center justify-center">
        <div className="relative w-[300px] sm:w-[800px] h-[150px] sm:h-[400px] opacity-5">
          <Image
        ...
        <div className="relative h-[50vh] md:h-[80vh]">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-white px-4">
            <div className="text-center">
              <h1 className="text-4xl sm:text-6xl font-bold mb-2 sm:mb-4">Brighton Resort</h1>
              <p className="text-lg sm:text-xl">Utah's Night Skiing Paradise</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
              {!brightonWeather ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
                  ...
                  <div className="text-center sm:text-left">
                    <h3 className="font-bold text-lg sm:text-xl mb-2 sm:mb-4">Wind</h3>
                    <p className="text-3xl sm:text-4xl font-bold text-blue-600">
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
              <div>
                ...
                <div className="mt-6 sm:mt-8">
                  <h3 className="font-bold text-base sm:text-lg mb-2">Trail Map</h3>
                  <a
                    href="https://www.brightonresort.com/trail-maps"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base"
                  >
