              ...
              {!brightonWeather ? (
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-4xl font-bold text-blue-600">
                      {Math.round(brightonWeather.hourly.snowfall[0] / 25.4 * 10) / 10}″
                    </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">Night Skiing</h3>
                    <p>30 lit trails</p>
                    <p>200+ acres</p>
                  </div>
                  <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Experience Utah's best night skiing with 30 lit trails.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2">•</span>
                    <div>
                      ...
                      <p className="text-gray-700">Multiple terrain parks for all skill levels.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2">•</span>
                    <div>
                      ...
                      <p className="text-gray-700">Comprehensive lessons for all ages and abilities.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2">•</span>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p>A local favorite featuring steep, open bowl skiing with multiple entry points. Perfect for powder days and advanced skiers looking for challenging terrain.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-2 flex items-center">
                ...
                <p>One of Brighton's most challenging runs with steep chutes and technical cliff bands. Reserved for expert skiers who can handle extreme terrain.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-2 flex items-center">
                ...
                <p>A diverse area offering a mix of terrain with open bowls, gladed runs, and groomed trails. Particularly popular during night skiing sessions.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-2 flex items-center">
                  <DifficultyIcon difficulty="black" />
                ...
                <p>A classic Brighton run featuring steep pitches and natural terrain features. One of the best runs for night skiing with excellent lighting.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-2 flex items-center">
                  <DifficultyIcon difficulty="various" />
                ...
                <p>An extensive area offering everything from gentle groomers to challenging off-piste terrain. Features stunning views of the Salt Lake Valley.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-2 flex items-center">
                  <DifficultyIcon difficulty="double-black" />
                ...
                <p>A challenging expert run with steep, rocky terrain that requires advanced technical skills. Best tackled after a fresh snowfall.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="font-bold text-xl mb-4">Day Skiing</h3>
                  <p className="mb-2">Monday - Sunday: 9:00 AM - 4:00 PM</p>
                  <p className="text-gray-600">Hours may vary based on conditions and time of year</p>
                </div>
                <div>
                  <h3 className="font-bold text-xl mb-4">Night Skiing</h3>
                  <p className="mb-2">Monday - Saturday: 4:00 PM - 9:00 PM</p>
                  <p className="text-gray-600">Available during winter season, weather permitting</p>
                </div>
              </div>
            </div>
          </div>
